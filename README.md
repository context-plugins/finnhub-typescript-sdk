...
# Getting Started with Finnhub API
...
![Version Check](https://apidocs.io/illustration/typescript?workspaceFolder=FinnhubApi&step=versionCheck)
...
![Resolve Dependencies](https://apidocs.io/illustration/typescript?workspaceFolder=FinnhubApi&workspaceName=finnhub-apilib&step=resolveDependency)
...
- The created project manages its dependencies using its `package.json` file. In order to add a dependency on the *Finnhub APILib* client library, double click on the `package.json` file in the bar on the left and add the dependency to the package in it.

![Add FinnhubApilib Dependency](https://apidocs.io/illustration/typescript?workspaceFolder=FinnhubApi&workspaceName=finnhub-apilib&step=importDependency)
...
![Install FinnhubApilib Dependency](https://apidocs.io/illustration/typescript?step=installDependency)
...
```ts
import { Client, LogLevel } from 'finnhub-apilib';
